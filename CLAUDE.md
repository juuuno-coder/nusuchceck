...
### 전략 핵심 요약
- **Vision**: AI 진단 + 검증된 전문가 + 투명한 에스크로로 누수 응급 시장 장악
- **Beachhead**: 서울/경기 아파트 주민 (누수 긴급) - 월 200-300건 접수
- **North Star**: 월간 활성 전문가당 평균 월 거래액 2,000,000원
- **즉시 과제**: Google Ads 테스트(5M예산), 전문가 10명 온보딩, NPS 70+ 조사
...
- **프로젝트 경로**: /root/projects/nusucheck/
- **Docker 네트워크**: npm_default

## 포트맵
| 포트 | 컨테이너명 | 도메인 |
|------|-----------|--------|
| 4080 | nusucheck-app | nusucheck.vibers.co.kr, nusucheck.com |

## Docker Compose 규칙
- 컨테이너명: nusucheck-app, nusucheck-db, nusucheck-redis
- DB: postgres:16-alpine
- Cache: redis:7-alpine
- Background: Sidekiq (nusucheck-sidekiq)
